            ...
            <section>
                <form method="post" action="" id="form-inscription">
                    <div class="form-container">
                        ...
                        <input type="text" name="userName" id="userName" @input="verifyUsername">
                    ...
                    <div class="form-container">
                        ...
                        <input type="email" name="email" id="email" @input="verifyEmail">
                        <i class="fas fa-check check"></i>
                        <i class="fas fa-times error"></i>
                    ...
                    <div class="form-container">
                        ...
                        <input type="password" name="password" id="password" @input="verifyPassword">
                        <i class="fas fa-check check"></i>
                        <i class="fas fa-times error"></i>
                    ...
                    <button type="submit" form="">Inscription</button>
                </form>
  ...
  methods: {
    verifyUsername : function(event){
        ...
        if(event.target.value.length >= 3 && event.target.value.length <= 50){
            ...
            btnForm.setAttribute('form', 'form-inscription');
        } 
